...
class SurfaceEMG:
  ...
  ### Plot parameters
    self.electrodes_in_z:int = 3 # Number of electrodes in the z-direction.
    self.electrodes_in_x:int = 3 # Number of electrodes in the x-direction.
  ...
  def simulate_surface_emg(self):
    ...
    if signal_to_noise_ratio_dB == 0:
      ...
      plt.plot(time_array, electrode_sum_with_noise[electrod_postion-1, :] * 10**3, label = 'sEMG with noise')
      plt.plot(time_array, electrode_sum[electrod_postion-1, :] * 10**2, label = 'Original sEMG')
      plt.legend()
      
      ax = plt.subplot(2,1,2)
      plt.plot(time_array, electrode_sum_with_noise[electrod_postion-1, :] * 10**2)
